...
sealed class AddClientEvent {
    ...
    data class EnteredClientAddress(val value: String): AddClientEvent()
    data class EnteredClientZipcode(val value: String): AddClientEvent()
    ...
    object ChooseDateOfBirth: AddClientEvent()
